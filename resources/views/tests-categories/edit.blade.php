...
<!-- Demo Content-->
	<div class="p-5 bg-white shadow-sm rounded h-100">
		<div>
			<h2 class="lead">Redaguoti testo kategoriją</h2>

			<div class="mt-4">
				<form action="{{ url('tests-categories/' . $single['id']) }}" method="POST">
					@csrf
					@method('PUT')
					...
					<div class="form-group">
						...
						<select class="form-control" name="parent_id" id="parent_id">
							...
							@include('tests-categories/recursive-option', array('category' => $categories[0], 'categories' => $categories, 'indent' => '', 'selected' => $single['parent_id']))
